...
(*                                                                        *)
(*  The results above show that selectivity and the meet property are    *)
(*  SUFFICIENT for the clone criterion.  They are also necessary, so the *)
(*  criterion sits in the same class as transitivity of the beat         *)
(*  relation and winner existence, and in particular is EQUIVALENT to    *)
(*  winner existence over this framework rather than merely implied by   *)
(*  the same conditions.                                                 *)
(*                                                                        *)
(*  The leverage is that the clone hypotheses constrain nothing about    *)
(*  the edges among the clones themselves, and are vacuous when the      *)
(*  original alternative set is the singleton [[d]].  In that degenerate *)
(*  configuration the criterion says exactly that an arbitrary matrix on *)
(*  an arbitrary nonempty set of clones admits an undefeated element, so *)
(*  the winner-existence witnesses of SocialchoiceN apply directly, with *)
(*  the replaced alternative [d] parked outside the witness as a dead    *)
(*  node.                                                                 *)
(* ===================================================================== *)
